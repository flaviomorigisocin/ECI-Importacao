...
@Component
public class RabbitMQConsumerBatimentoCaixa implements AmqpConsumer<String> {

    @Autowired
    private ConsumerService consumerService;

    @Override
    @RabbitListener(queues = "${fila.batimento_caixa}", autoStartup = "${fila.batimento_caixa_start}")
