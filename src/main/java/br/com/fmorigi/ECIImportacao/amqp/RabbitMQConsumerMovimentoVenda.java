...
@Component
public class RabbitMQConsumerMovimentoVenda implements AmqpConsumer<String> {

    @Autowired
    private ConsumerService consumerService;

    @Override
    @RabbitListener(queues = "${fila.movimento_venda}", autoStartup = "${fila.movimento_venda_start}")
